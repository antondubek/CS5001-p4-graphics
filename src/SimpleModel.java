...
public class SimpleModel {
     ...
     * The method adds the text entered by the user to its buffer and calls notifier.firePropertyChange
    ...
    /**
     * This method can be called by the GUI view aspect of the delegate to get hold of the text in the model's buffer.
